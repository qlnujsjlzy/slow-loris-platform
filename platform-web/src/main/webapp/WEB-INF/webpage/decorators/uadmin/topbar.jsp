...
<div id="header-topbar-option-demo" class="page-header-topbar">
    <nav id="topbar" role="navigation" style="margin-bottom: 0; z-index: 2;"
        ...
        <div class="navbar-header">
            ...
            <a id="logo" href="${adminPath}" class="navbar-brand"><span class="fa fa-rocket"></span><span
                    class="logo-text">Slow-Loris</span><span style="display: none" class="logo-text-icon">JW</span></a>
        </div>
        <div class="topbar-main"><a id="menu-toggle" href="#" class="hidden-xs"><i class="fa fa-bars"></i></a>
            <ul class="nav navbar-nav    ">
                <li class="active"><a href="${adminPath}">控制台</a>
                </li>
                <li><a href="javascript:;" data-toggle="dropdown" class="dropdown-toggle">Layouts&nbsp;<i
                ...
                <li class="mega-menu-dropdown"><a href="javascript:;" data-toggle="dropdown" class="dropdown-toggle">UI
                            ...
                            <div class="mega-menu-content">
                                <div class="row">
                                    <ul class="col-md-4 mega-menu-submenu">
                                        ...
                                        <li><a href="#"><i class="fa fa-angle-right"></i>Et harum quidem rerum facilis
                                            est</a>
                                        </li>
                                    </ul>
                                    <ul class="col-md-4 mega-menu-submenu">
            ...
            <ul class="nav navbar navbar-top-links navbar-right mbn">
                <li class="dropdown" style="display:none;"><a data-hover="dropdown" href="#" class="dropdown-toggle"><i
                ...
                <li class="dropdown topbar-user">
                    <a data-hover="dropdown" href="#" class="dropdown-toggle"><img
                            src="${appPath}/${fns:getUser().portrait}" alt=""
                            class="img-responsive img-circle"/>&nbsp;<span
                            class="hidden-xs">${fns:getUser().realname}</span>&nbsp;<span class="caret"></span>
                    </a>
                    <ul class="dropdown-menu dropdown-user pull-right">
                        <li><a href="#"><i class="fa fa-user"></i>个人信息</a></li>
                        <li><a href="${adminPath}/sys/user/${fns:getUser().id}/avatar"><i
                                class="fa fa-camera-retro"></i>修改头像</a></li>
                ...
                <li class="dropdown hidden-xs">
                    <!--BEGIN THEME SETTING--><a id="theme-setting" href="javascript:;" data-hover="dropdown"
                                                 data-step="1"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="changePasswordForm" method="post"
                          action="${adminPath}/sys/user/${fns:getUser().id}/changePassword" class="form">
                        <div class="form-group">
                            <div class="input-icon right"><i class="fa fa-key"></i>
                                <input type="password" value="" name="password" class="form-control" datatype="*6-16"
                        ...
                        <div class="form-group">
                            <div class="input-icon right"><i class="fa fa-key"></i>
                                <input type="password" value="" name="userpassword2" class="form-control" datatype="*"
