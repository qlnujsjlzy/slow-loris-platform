            ...
            <li class="user-panel">
                ...
                <div class="info">
                    ...
                    <ul class="list-inline list-unstyled">
                        ...
                        <li><a href="${adminPath}/sys/user/${fns:getUser().id}/avatar" data-hover="tooltip"
                               title="修改头像"><i class="fa fa-camera-retro"></i></a>
                        </li>
                        <li><a href="#" data-hover="tooltip" title="修改密码" data-toggle="modal"
                               data-target="#change-password"><i class="fa fa-key"></i></a></li>
