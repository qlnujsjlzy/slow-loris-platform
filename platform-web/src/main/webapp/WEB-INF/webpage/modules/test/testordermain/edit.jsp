...
<form:form id="testOrderMainForm" modelAttribute="data" method="post" class="form-horizontal">
    ...
    <table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
        ...
        <tr>
            ...
            <td class="width-35">
                <form:input path="orderdate" htmlEscape="false" class="form-control layer-date"
        ...
        <div class="tab-content">
            <div id="tab_testOrderTicket" class="tab-pane active">
                <div class="panel-body">
                    <grid:grid id="testOrderTicket" datas="${testOrderTicketList}" gridShowType="form" pageable="false"
                               editable="true">
            ...
            <div id="tab_testOrderCustomer" class="tab-pane ">
                <div class="panel-body">
                    <grid:grid id="testOrderCustomer" datas="${testOrderCustomerList}" gridShowType="form"
                               pageable="false" editable="true">
