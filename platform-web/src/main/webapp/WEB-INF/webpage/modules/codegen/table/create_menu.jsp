...
<form:form id="menuForm" modelAttribute="data" action="${adminPath}/sys/menu/save" method="post"
    ...
    <table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
        ...
        <tr>
            ...
            <td class="width-35">
                <form:treeselect title="请选择上级菜单" path="parentId" dataUrl="${adminPath}/sys/menu/treeData"
                                 labelName="parentname" labelValue="${data.parent.name}"/>
            </td>
