...
<form:form id="genForm" action="${adminPath}/codegen/table/generateCode" method="post" class="form-horizontal">
    ...
    <table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
        ...
        <tr>
            ...
            <td>
                <form:input path="pathName" class="form-control" nested="false" value="${scheme.pathName}" datatype="*"
                            nullmsg="请输入代码生成目录！" htmlEscape="false"/>
        ...
        <tr>
            ...
            <td>
                <form:input path="packageName" class="form-control" nested="false" value="${scheme.packageName}"
                            datatype="*" nullmsg="请输入生成包路径！" htmlEscape="false"/>
                <label class="Validform_checktip"></label>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <form:input path="moduleName" class="form-control" nested="false" value="${scheme.moduleName}"
                            datatype="*" nullmsg="请输入生成模块名！" htmlEscape="false"/>
                <label class="Validform_checktip"></label>
            </td>
        </tr>
        <tr style="display:none;">
            ...
            <td>
                <form:input path="subModuleName" class="form-control" value="${scheme.subModuleName}" nested="false"
                            htmlEscape="false"/>
                <label class="Validform_checktip"></label>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <form:input path="entityName" class="form-control" value="${scheme.entityName}" nested="false"
                            datatype="*" nullmsg="请输入实体类名(首字母大写)！" htmlEscape="false"/>
                <label class="Validform_checktip"></label>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <form:input path="functionDesc" class="form-control" value="${scheme.functionDesc}" nested="false"
                            datatype="*" nullmsg="请输入生成功能描述！" htmlEscape="false"/>
                <label class="Validform_checktip"></label>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <form:input path="functionName" class="form-control" value="${scheme.functionName}" nested="false"
                            datatype="*" nullmsg="请输入生成功能名！" htmlEscape="false"/>
                <label class="Validform_checktip"></label>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <form:input path="functionAuthor" class="form-control" nested="false" value="${scheme.functionAuthor}"
                            datatype="*" nullmsg="请输入生成功能作者！" htmlEscape="false"/>
                <label class="Validform_checktip"></label>
            </td>
        </tr>
        <tr>
