...
<div class="ibox-content">
    <form:form id="inputForm" modelAttribute="data" action="${adminPath}/codegen/table/save" method="post"
        ...
        <table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
            ...
            <tr>
                ...
                <td class="width-35">
                    <form:input path="tableName" class="form-control " datatype="*" nullmsg="请输入表名称！"
                                htmlEscape="false"/>
                ...
                <td class="width-35">
                    <form:input path="className" class="form-control " datatype="*" nullmsg="请输入表类名！"
                                htmlEscape="false"/>
                    <label class="Validform_checktip"></label>
    ...
    <button class="btn btn-white btn-sm" onclick="return addRowData('attributeInfoTable')"><i class="fa fa-plus"> 增加</i>
    </button>
    <button class="btn btn-white btn-sm" onclick="return delRowData('attributeInfoTable')"><i class="fa fa-minus">
        删除</i></button>
    <div class="row">
