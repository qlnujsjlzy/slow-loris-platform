    ...
    <div class="col-lg-12">
        ...
        <form id="loginform" method="post" class="form-horizontal login-form" action=""
            ...
            <div class="form-group ">
                <div class="col-lg-12">
                    <input name="username" value="admin" class="form-control"
            ...
            <div class="form-group">
                <div class="col-lg-12">
                    <input name="password" value="123456" class="form-control"
                           placeholder="<spring:message code="sys.login.password.placeholder"/>" required="">
                </div>
            </div>
            <c:if test="${showCaptcha eq 1}">
                <div class="form-group">
                    <div class="col-lg-6">
                        <input name="jcaptchaCode" class="form-control"
                               placeholder="<spring:message code="sys.login.captcha.placeholder"/>" required="">
                    </div>
                    <div class="col-lg-6">
                        <img id="img_jcaptcha" src="${appPath}/jcaptcha.jpg" width="100" height="35"
                             onclick="changeJcaptchaSrc();"/>
                    </div>
                </div>
            </c:if>
            ...
            <button type="submit" class="btn btn-primary block full-width m-b"><spring:message
                    code="sys.login.submit.label"/></button>
