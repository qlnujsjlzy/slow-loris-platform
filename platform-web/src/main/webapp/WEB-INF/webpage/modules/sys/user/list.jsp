...
<div class="row">
    <div class="col-sm-3 col-md-2">
        <view:treeview id="organizationTreeview" dataUrl="${adminPath}/sys/organization/bootstrapTreeData"
    ...
    <div class="col-sm-9 col-md-10">
        <grid:grid id="userGridId" url="${adminPath}/sys/user/ajaxList">
            ...
            <grid:toolbar title="sys.user.modifypwd" icon="fa-database" function="updateDialog"
