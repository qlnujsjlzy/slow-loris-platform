        ...
        <div class="col-sm-12">
            <div class="portlet box  portlet-grey">
                ...
                <div class="portlet-body">
                    <form:form id="emailForm" modelAttribute="data" action="${adminPath}/sys/setting/email"
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="col-sm-8">
                                <form:input path="port" class="form-control" defaultvalue="25" datatype="*"
                                            htmlEscape="false"/>
                            </div>
                        </div>
                        <div class="form-group col-sm-6">
                            ...
                            <div class="col-sm-8">
                                <form:radiobuttons path="auth" items="${trueOrFalse}" datatype="*"
                                                   cssClass="form-control i-checks"/>
                            </div>
                        </div>
                        <div class="form-group col-sm-6">
                            <label class="col-sm-4 control-label"><font color="red">*</font>认证用户名：</label>
                            <div class="col-sm-8">
                                <form:input path="username" defaultvalue="" datatype="*" htmlEscape="false"
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="col-sm-8">
                                <form:input path="password" defaultvalue="" datatype="*" htmlEscape="false"
                                            cssClass="form-control"/>
                            </div>
                        </div>
                        <div class="form-group col-sm-6">
