    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="col-sm-6">
                <div class="portlet box  portlet-grey">
                    <div class="portlet-header">
                        <div class="caption">云通讯配置<a href="http://www.yuntongxun.com/" target="_blank">http://www.yuntongxun.com/</a>
                        </div>
                        <div class="tools">
                    ...
                    <div class="portlet-body">
                        <form:form id="cloudSmsForm" modelAttribute="cloudSms"
                                   action="${adminPath}/sys/setting/cloudsms" method="post" class="form-horizontal">
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <div class="col-sm-8">
                                    <form:input path="serverport" class="form-control" defaultvalue="25" datatype="*"
                                                htmlEscape="false"/>
                                </div>
                            </div>
                            <div class="form-group col-sm-12">
                                ...
                                <div class="col-sm-8">
                                    <form:input path="accountsid" defaultvalue="" datatype="*" htmlEscape="false"
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <div class="col-sm-8">
                                    <form:input path="accounttoken" defaultvalue="" datatype="*" htmlEscape="false"
                                                cssClass="form-control"/>
                                </div>
                            </div>
                            <div class="form-group col-sm-12">
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <div class="col-sm-8">
                                    <form:input path="testphone" nested="false" htmlEscape="false"
                                                cssClass="form-control"/>
                                </div>
                            </div>
                            <div class="form-group col-sm-12">
                                ...
                                <div class="col-sm-8">
                                    <form:input path="testtemplateId" nested="false" htmlEscape="false"
                                                cssClass="form-control"/>
                                </div>
                            </div>
                            <div class="form-group col-sm-12">
                                ...
                                <div class="col-sm-8">
                                    <form:input path="testdata" nested="false" htmlEscape="false"
                                                cssClass="form-control"/>
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-3">
                                    ...
                                    <input class="btn btn-warning" style="dispaly:none;" type="button"
                                           onclick="testSms();" value="测试"/>
                                </div>
                            </div>
                        </form:form>
                    </div>
            ...
            <div class="col-sm-6">
                <div class="portlet box  portlet-grey">
                    <div class="portlet-header">
                        <div class="caption">互亿无线 <a href="http://www.ihuyi.com/"
                                                     target="_blank">http://www.ihuyi.com/</a></div>
                        <div class="tools">
                            <i class="fa fa-chevron-up"></i>
                            <i class="fa fa-refresh"></i><i class="fa fa-times"></i>
                        </div>
                    ...
                    <div class="portlet-body">
                        <form:form id="hySmsForm" modelAttribute="hySms" action="${adminPath}/sys/setting/hysms"
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <div class="col-sm-8">
                                    <form:input path="apikey" class="form-control" defaultvalue="25" datatype="*"
                                                htmlEscape="false"/>
                                </div>
                            </div>
                            <div class="form-group col-sm-12">
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <div class="col-sm-8">
                                    <form:textarea path="testcontent" cssClass="form-control" nested="false" rows="3"
                                                   cols="30"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-3">
                                    <input class="btn  btn-primary" style="dispaly:none;" type="button"
                                           onclick="saveHySms();" value="提交"/>
                                    <input class="btn  btn-warning" style="dispaly:none;" type="button"
                                           onclick="testHySms();" value="测试"/>
                                </div>
                            </div>
                        </form:form>
                    </div>
