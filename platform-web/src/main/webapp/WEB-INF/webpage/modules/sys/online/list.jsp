...
<grid:grid id="onlineGridId" datatype="local" datas="${onlineSessionList}" sortname="startTimestamp" sortorder="desc">
    ...
    <grid:toolbar title="强制退出" btnclass="btn-danger" icon="fa-trash-o" function="toolbarSelectConfirm"
                  url="${adminPath}/sys/online/forceLogout" tipMsg="您确定要强制退出这些信息么，请谨慎操作！"/>
</grid:grid>
</body>
</html>