...
<form:form id="dictForm" modelAttribute="data" method="post" class="form-horizontal">
    ...
    <table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
        ...
        <tr>
            ...
            <td class="width-35">
                <form:input path="value" class="form-control" htmlEscape="false" datatype="*" errormsg="字典值必须为英文"
                            nullmsg="请输入字典值编码！"/>
                <label class="Validform_checktip"></label>
            </td>
        </tr>
        <tr>
            ...
            <td class="width-35">
                <form:input path="sort" class="form-control " datatype="n" nullmsg="请输入排序值！" errormsg="请输入数字"
                            htmlEscape="false"/>
                <label class="Validform_checktip"></label>
            </td>
            <td class="width-15 active text-right"><label><font color="red">*</font>备注:</label></td>
            <td class="width-35" colspan="3"><form:textarea path="remarks" htmlEscape="false" rows="3" maxlength="200"
