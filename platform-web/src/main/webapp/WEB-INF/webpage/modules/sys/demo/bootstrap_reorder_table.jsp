...
<head>
    ...
    <link rel="stylesheet"
          href="${adminPath}/static/bootstrap-table/extensions/reorder-rows/bootstrap-table-reorder-rows.css">
                        ...
                        <div id="contentTableQuery" class="col-sm-12">
                            <div class="form-inline">
                                <div class="form-group">
                                    <span>字典标签：</span>
                                    <input name="name" value="" htmlEscape="false" maxlength="64"
                        ...
                        <div class="col-sm-12">
                            <div class="pull-left">
                                <button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left"
                                        onclick="add('新增','${adminPath}/admin/dict/edit?gid=${group.id}')" title="添加"><i
                                        class="fa fa-plus"></i> 添加
                                </button>
                                <button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left"
                                        onclick="update('修改','${adminPath}/admin/dict/edit','contentTable')" title="修改">
                                    <i class="fa fa-file-text-o"></i> 修改
                                </button>
                                <button class="btn btn-white btn-sm"
                                        onclick="deleteALLSelect('删除','${adminPath}/admin/dict/batchDelete','contentTable')"
                                        data-toggle="tooltip" data-placement="top"><i class="fa fa-trash-o"> 删除</i>
                                    <button class="btn btn-white btn-sm " data-toggle="tooltip" data-placement="left"
                                            onclick="refreshTable('contentTable')" title="刷新"><i
                                            class="glyphicon glyphicon-repeat"></i> 刷新
                                    </button>
                            </div>
                            <div class="pull-right">
                                <button class="btn btn-primary btn-rounded btn-outline btn-sm "
                                        onclick="doSearch('contentTable')"><i class="fa fa-search"></i> 查询
                                </button>
                                <button class="btn btn-primary btn-rounded btn-outline btn-sm "
                                        onclick="searchReset('contentTable')"><i class="fa fa-refresh"></i> 重置
                                </button>
                            </div>
                        </div>
                    </div>
...
<!-- 系统公用JS -->
<script src="${adminPath}/static/common/js/slow_loris.js"></script>
