...
<form:form id="datasourceForm" modelAttribute="data" method="post" class="form-horizontal">
    ...
    <table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
        ...
        <tr>
            ...
            <td class="width-35">
                <form:input path="dbKey" class="form-control " datatype="/^[a-zA-Z 0-9]+$/" errormsg="数据库关键字必须为英文"
                            htmlEscape="false"/>
            ...
            <td class="width-35">
                <form:select path="dbType" dict="dbtype" class="form-control" htmlEscape="false" datatype="*"
                             nullmsg="请输入数据库类型！"/>
                <label class="Validform_checktip"></label>
            </td>
        </tr>
