...
<grid:grid id="groupGridId" url="${adminPath}/sys/dict/ajaxList?gid=${group.id}" editable="true">
    ...
    <grid:toolbar title="sys.common.add" icon="fa-plus" function="add"
                  url="${adminPath}/sys/dict/edit?gid=${group.id}"/>
    <grid:toolbar title="sys.common.update" icon="fa-file-text-o" function="update" url="${adminPath}/sys/dict/edit"/>
    <grid:toolbar title="sys.common.delete" icon="fa-trash-o" function="deleteALLSelect"
                  url="${adminPath}/sys/dict/batchDelete"/>
