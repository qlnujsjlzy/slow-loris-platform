(function (root, factory) {
    ...
    Formatter = (function (_super) {
        ...
        Formatter.prototype.cleanNode = function (node, recursive) {
            var $childImg, $node, $p, $td, allowedAttributes, attr, contents, isDecoration, n, text, textNode, _i, _j,
                _len, _len1, _ref, _ref1;
            $node = $(node);
            if (!($node.length > 0)) {
                return;
            }
    ...
    InputManager = (function (_super) {
        ...
        InputManager.prototype._onPaste = function (e) {
            ...
            return setTimeout((function (_this) {
                return function () {
                    var $img, blob, children, insertPosition, lastLine, line, lines, node, pasteContent, _i, _j, _k, _l,
                        _len, _len1, _len2, _len3, _len4, _m, _ref1, _ref2, _ref3;
    ...
    Util = (function (_super) {
        ...
        Util.prototype.dataURLtoBlob = function (dataURL) {
            var BlobBuilder, arrayBuffer, bb, byteString, hasArrayBufferViewSupport, hasBlobConstructor, i, intArray,
                mimeString, _i, _ref;
    ...
    ListButton = (function (_super) {
        ...
        ListButton.prototype.command = function (param) {
            var $contents, $endBlock, $furthestEnd, $furthestStart, $parent, $startBlock, endLevel, endNode,
                getListLevel, node, range, results, startLevel, startNode, _i, _len, _ref;
            range = this.editor.selection.getRange();
            startNode = range.startContainer;
            endNode = range.endContainer;
            $startBlock = this.editor.util.closestBlockEl(startNode);
    ...
    LinkButton = (function (_super) {
        ...
        LinkButton.prototype.command = function () {
            ...
            if (this.active) {
                ...
                $link = $('<a/>', {
                    href: 'http://www.yunsupermarket.cn',
                    target: '_blank',
