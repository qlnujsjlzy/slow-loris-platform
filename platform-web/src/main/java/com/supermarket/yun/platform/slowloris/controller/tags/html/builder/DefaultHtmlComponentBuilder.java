...
import com.supermarket.yun.platform.slowloris.controller.tags.html.exception.HtmlComponentException;
import com.supermarket.yun.platform.slowloris.controller.tags.html.resolver.HtmlComponentDTDEntityResolver;
...
public class DefaultHtmlComponentBuilder implements HtmlComponentBuilder, ResourceLoaderAware {
    ...
    private void putStatementToCacheMap(Resource resource, final Element element, Map<String, String> statementMap)
        ...
        System.out.println("putStatementToCacheMap =" + statementId + ":" + queryText);
