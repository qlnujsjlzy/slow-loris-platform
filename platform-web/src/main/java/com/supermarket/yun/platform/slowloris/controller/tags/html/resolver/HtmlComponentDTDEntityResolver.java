package com.supermarket.yun.platform.slowloris.controller.tags.html.resolver;
...
public class HtmlComponentDTDEntityResolver implements EntityResolver, Serializable {
    ...
    private static final String HOP_DYNAMIC_STATEMENT = "http://www.yunsupermarket.cn/dtd/";
    ...
    public InputSource resolveEntity(String publicId, String systemId) {
        ...
        if (systemId != null) {
            ...
            if (systemId.startsWith(HOP_DYNAMIC_STATEMENT)) {
                LOGGER.debug(
                        "recognized hop html component namespace attempting to resolve on classpath under com/supermarket/yun/platform/slowloris/controller/tags/html/dtd/");
    ...
    private InputSource resolveOnClassPath(String publicId, String systemId, String namespace) {
        ...
        String path = "com/supermarket/yun/platform/slowloris/controller/tags/html/dtd/" + systemId.substring(namespace.length());
