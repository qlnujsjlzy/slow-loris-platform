...
public class ${entityName?cap_first}ServiceImpl  extends CommonServiceImpl
<${entityName?cap_first}Mapper,${entityName?cap_first}> implements  I${entityName?cap_first}Service {
