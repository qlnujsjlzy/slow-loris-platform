package com.supermarket.yun.platform.slowloris.dao.system.impl;
...
import com.supermarket.yun.platform.slowloris.common.utils.SqlUtils;
...
public class GeneratorDaoImpl implements IGeneratorDao {
    ...
    public void createTable(Map<String, Object> tableInfo) throws TemplateException, IOException {
        ...
        LOGGER.info("createTable createTableSql={}", createTableSql);
    ...
    public List<DbTableInfo> getDbTables() {
        ...
        try {
            ...
            if (driverName.contains("ORACLE")) {
                resultSet = connection.getMetaData().getTables(null, propertiesUtil.getString("connection.username"), null, types);
            } else {
