...
public class OnlineSession extends SimpleSession {
     ...
     *
     * @param bitMask      the aggregate bitmask for all fields that have been
     ...
     * @param fieldBitMask the field bit mask constant identifying which bit to inspect
     ...
     * @throws java.io.IOException if any of this object's fields cannot be written to the
     *                             stream.
     * @since 1.0
     */
     ...
     * Serialization.
     *
     * @param in the input stream to use for reading data to populate this
     *           object.
     * @throws IOException            if the input stream cannot be used.
     * @throws ClassNotFoundException if a required class needed for instantiation is not available
     *                                in the present JVM
     * @since 1.0
     */
