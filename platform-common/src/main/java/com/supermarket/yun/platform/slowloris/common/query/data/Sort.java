...
public class Sort implements Iterable<Sort.Order>, Serializable {
     ...
     *
     * @param properties must not be {@literal null} or contain {@literal null} or
     *                   empty strings
     */
     ...
     * Creates a new {@link Sort} instance.
     *
     * @param direction  defaults to {@linke Sort#DEFAULT_DIRECTION} (for
    ...
    public static class Order implements Serializable {
         ...
         *                   {@link Sort#DEFAULT_DIRECTION}
         * @param property   must not be {@literal null} or empty.
         * @param ignoreCase true if sorting should be case insensitive. false if
